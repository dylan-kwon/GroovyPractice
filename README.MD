...
### Mac <a name="install_mac"></a>
`brew install groovy`


### Windows <a name="install_windows"></a>
...
### 7. switch-case <a name="switch-case"></a>
...
### 9. try-catch-finally <a name="try-catch-finally"></a>
- `Java`와 비슷하다.
